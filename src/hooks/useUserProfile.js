...
export function useUserProfile() {
    ...
    var loadUserProfile = function () { return __awaiter(_this, void 0, void 0, function () {
        var user, userProfile, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    return [4 /*yield*/, models.Artist.get({ id: user.userId })];
                case 2:
                    userProfile = _a.sent();
    ...
    var updateProfile = function (data) { return __awaiter(_this, void 0, void 0, function () {
        var user, updateData, response, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setLoading(true);
                ...
                case 2:
                    user = _a.sent();
                    updateData = __assign(__assign({}, data), { id: user.userId });
                    return [4 /*yield*/, models.Artist.update(updateData)];
                case 3:
                    response = _a.sent();
