...
export function useAuthFlow() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, signIn({ username: email, password: password })];
                case 2:
                    _a.sent();
                    navigate('/');
                    return [3 /*break*/, 5];
    ...
    var register = function (name, email, password) { return __awaiter(_this, void 0, void 0, function () {
        var err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    err_2 = _a.sent();
                    setError(err_2 instanceof Error ? err_2.message : 'Registration failed');
                    throw err_2;
                case 4:
                    setLoading(false);
                    return [7 /*endfinally*/];
